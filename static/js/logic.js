// create the URL variable for the geoJason
...
d3.json(url).then(function(data){
    console.log(data)
    // initiate for loop to add the new markers 
    for (var i = 0; i < data.features.length; i++){
        ...
        // Create the markers for each earthquake report and add to the baseMap layer.
        L.circle(coords, {
            opacity: .5,
            fillOpacity: 0.75,
            weight: .5,
